...
pub use execution::{FixtureExecutor, generate_test_code_with_fixtures};
pub use builtin::{is_builtin_fixture, get_builtin_fixture_metadata, generate_builtin_fixture_code};
...
impl FixtureManager {
    ...
    pub fn get_fixture_value(&self, name: &str, test_id: &str) -> Result<Option<serde_json::Value>> {
        let fixture = self.fixtures.get(name)
    ...
    fn register_builtin_fixtures(&mut self) {
        // Register tmp_path
        self.fixtures.insert("tmp_path".to_string(), Fixture {
        ...
        // Register capsys
        self.fixtures.insert("capsys".to_string(), Fixture {
        ...
        self.fixtures.insert("monkeypatch".to_string(), Fixture {
...
pub fn extract_fixture_deps(test_function: &crate::parser::TestFunction, content: &str) -> Vec<String> {
