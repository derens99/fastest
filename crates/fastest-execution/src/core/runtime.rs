...
struct RuntimeCommand {
    ...
    #[allow(dead_code)]
    data: serde_json::Value, // Note: Keep serde_json::Value type for compatibility, but use SIMD serialization
}
...
struct TestExecutionData {
    ...
    fixtures: Vec<String>,
    #[allow(dead_code)]
    params: Option<serde_json::Value>, // Note: Keep serde_json::Value type for compatibility
    #[allow(dead_code)]
    markers: Vec<String>,
    #[allow(dead_code)]
...
struct EnhancedPythonWorker {
    ...
    #[allow(dead_code)]
    fixture_cache: Arc<Mutex<HashMap<String, serde_json::Value>>>, // Note: Keep serde_json::Value type for compatibility
    #[allow(dead_code)]
    worker_id: usize,
}
...
impl EnhancedPythonWorker {
    ...
    fn execute_command(&self, cmd: &RuntimeCommand) -> Result<RuntimeResponse> {
        // Send command
        {
            ...
            let json_str = simd_json::to_string(cmd)
    ...
    fn setup_fixtures(&self, fixtures: &[Fixture]) -> Result<HashMap<String, serde_json::Value>> {
        let fixture_data: Vec<FixtureSetupData> = fixtures
            ...
            .map(|f| FixtureSetupData {
                ...
                scope: match f.scope {
                    ...
                    FixtureScope::Package => "package".to_string(),
                },
        ...
        let cmd = RuntimeCommand {
            ...
            data: serde_json::Value::Null, // Note: Using serde_json::Value type but SIMD serialization
        };
    ...
    fn prepare_test_execution_data(&self, test: &TestItem) -> TestExecutionData {
        ...
        let params = test
            ...
            .and_then(|d| {
                ...
                simd_json::from_str::<serde_json::Value>(json_str).ok()
            });
